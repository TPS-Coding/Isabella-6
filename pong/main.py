...
class Game():
    def __init__(self):
        ...
        pygame.display.set_caption("Isabella's Pong")
    ...
    def display_score(self):
        player_surf = self.font.render(str(self.player_score),True,'purple')
        ...
        cpu_surf = self.font.render(str(self.cpu_score), True, 'purple')
        ...
        pygame.draw.line(self.display_surface, 'purple', start, end, 10)
